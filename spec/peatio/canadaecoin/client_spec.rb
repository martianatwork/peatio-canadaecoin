RSpec.describe Peatio::Canadaecoin::Client do
  ...
  subject { Peatio::Canadaecoin::Client.new(uri) }
    ...
    context :methodnotfound do
      ...
      it do
        expect{ subject.json_rpc(:methodnotfound) }.to \
          raise_error(Peatio::Canadaecoin::Client::ResponseError, "Method not found (-32601)")
      end
    end
    ...
    context :notfound do
      ...
      it do
        expect{ subject.json_rpc(:notfound) }.to \
          raise_error(Peatio::Canadaecoin::Client::Error)
      end
    end
    ...
    context :connectionerror do
      ...
      it do
        expect{ subject.json_rpc(:connectionerror) }.to \
          raise_error(Peatio::Canadaecoin::Client::ConnectionError)
      end
    end
  end
end
