RSpec.describe Peatio::Canadaecoin::Blockchain do
  context :features do
    it 'defaults' do
      blockchain1 = Peatio::Canadaecoin::Blockchain.new
      expect(blockchain1.features).to eq Peatio::Canadaecoin::Blockchain::DEFAULT_FEATURES
    end

    it 'override defaults' do
      blockchain2 = Peatio::Canadaecoin::Blockchain.new(cash_addr_format: true)
      expect(blockchain2.features[:cash_addr_format]).to be_truthy
    end

    it 'custom feautures' do
      blockchain3 = Peatio::Canadaecoin::Blockchain.new(custom_feature: :custom)
      expect(blockchain3.features.keys).to contain_exactly(*Peatio::Canadaecoin::Blockchain::SUPPORTED_FEATURES)
    end
  end

  context :configure do
    let(:blockchain) { Peatio::Canadaecoin::Blockchain.new }
    it 'default settings' do
      expect(blockchain.settings).to eq({})
    end

    it 'currencies and server configuration' do
      currencies = [{ id: :canadaecoin,
  ...
  context :latest_block_number do
    ...
    let(:blockchain) do
      Peatio::Canadaecoin::Blockchain.new.tap {|b| b.configure(server: server)}
    end
  ...
  context :build_transaction do
    ...
    context 'three vout tx' do
      ...
      let(:blockchain) do
        Peatio::Canadaecoin::Blockchain.new.tap { |b| b.configure(currencies: [currency]) }
      end
    ...
    context 'multiple currencies' do
      ...
      let(:blockchain) do
        Peatio::Canadaecoin::Blockchain.new.tap do |b|
  ...
  context :fetch_block! do
    ...
    let(:getrawtransaction_response_file_bd89db90e3c7f5e88ce956950bc05643609926cfc3dfc0b224f849ed39b3ad7b) do
      File.join('spec', 'resources', 'getrawtransaction_bd89db90e3c7f5e88ce956950bc05643609926cfc3dfc0b224f849ed39b3ad7b', 'bd89db90e3c7f5e88ce956950bc05643609926cfc3dfc0b224f849ed39b3ad7b.json')
      end
    ...
    let(:getrawtransaction_response_bd89db90e3c7f5e88ce956950bc05643609926cfc3dfc0b224f849ed39b3ad7b) do
      getrawtransaction_response_file_bd89db90e3c7f5e88ce956950bc05643609926cfc3dfc0b224f849ed39b3ad7b
        .yield_self { |file_path| File.open(file_path) }
        .yield_self { |file| JSON.load(file) }
      end
    ...
    before do
      ...
      stub_request(:post, server_without_authority)
        .with(body: { jsonrpc: '1.0',
                      ...
                      params:  ['bd89db90e3c7f5e88ce956950bc05643609926cfc3dfc0b224f849ed39b3ad7b',1] }.to_json)
    ...
    let(:server_without_authority) { 'http://127.0.0.1:19332' }
    let(:blockchain) do
      Peatio::Canadaecoin::Blockchain.new.tap { |b| b.configure(server: server, currencies: [currency]) }
    end
  ...
  context :load_balance_of_address! do
    ...
    let(:response_file) do
      File.join('spec', 'resources', 'listaddressgroupings', 'bd89db90e3c7f5e88ce956950bc05643609926cfc3dfc0b224f849ed39b3ad7b.json')
    end
    ...
    context 'address with balance is defined' do
      it 'requests rpc listaddressgroupings and finds address balance' do
        ...
        result = blockchain.load_balance_of_address!(address, :canadaecoin)
    ...
    context 'address is not defined' do
      it 'requests rpc listaddressgroupings and do not find address' do
        ...
        expect{ blockchain.load_balance_of_address!(address, :canadaecoin)}.to raise_error(Peatio::Blockchain::UnavailableAddressBalanceError)
      end
    end
    ...
    context 'client error is raised' do
      ...
      it 'raise wrapped client error' do
        expect{ blockchain.load_balance_of_address!('anything', :canadaecoin)}.to raise_error(Peatio::Blockchain::ClientError)
      end
    end
  end
end
