RSpec.describe Peatio::Canadaecoin::Wallet do
  let(:wallet) { Peatio::Canadaecoin::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Canadaecoin::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Canadaecoin::Wallet::SUPPORTED_SETTINGS))
    end
  end
  ...
  context :create_address! do
    ...
    let(:response_file) do
      File.join('spec', 'resources', 'getnewaddress', 'bd89db90e3c7f5e88ce956950bc05643609926cfc3dfc0b224f849ed39b3ad7b.json')
    end
  ...
  context :create_transaction! do
    ...
    let(:response_file) do
      File.join('spec', 'resources', 'sendtoaddress', 'bd89db90e3c7f5e88ce956950bc05643609926cfc3dfc0b224f849ed39b3ad7b.json')
    end
  ...
  context :load_balance! do
    ...
    let(:response_file) do
      File.join('spec', 'resources', 'getbalance', 'bd89db90e3c7f5e88ce956950bc05643609926cfc3dfc0b224f849ed39b3ad7b.json')
    end
